    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 flex items-center justify-center p-4 font-serif">
              ...
              <motion.div
                ...
                style={{ 
                  color: [
                    ...
                    '#FF9FF3', '#F368E0', '#FF9F43', '#54A0FF', '#00D2D3'
                  ][i % 10],
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8 relative">
          ...
          <p className="text-gray-300 text-lg font-light tracking-wide">Spin to reveal your amazing prize!</p>
        </motion.div>
          ...
          {currentValues.map((value, index) => (
            ...
            >
              <motion.div
                ...
                animate={index === 0 ? "sticky" : (isSpinning ? "flip" : blastAnimation ? "blast" : "initial")}
