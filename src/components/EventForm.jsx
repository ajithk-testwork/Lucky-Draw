          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 lg:px-8">
            ...
            <div className="flex justify-center pt-4 sm:pt-6">
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full text-white sm:w-auto px-6 sm:px-12 py-3 sm:py-4 text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl shadow-lg transform transition-all duration-200 focus:outline-none focus:ring-2 sm:focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 ${
                  isLoading
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-xl w-full max-w-4xl mx-auto overflow-y-auto max-h-[95vh]">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h1 className="text-lg sm:text-xl font-bold text-white">Registration Successful</h1>
                    <p className="text-blue-100 mt-1 text-xs sm:text-sm">Your registration has been confirmed and processed</p>
                  </div>
                </div>
                <div className="sm:block">
                  <div className="bg-white bg-opacity-20 px-2 py-1 sm:px-3 sm:py-1 rounded-full">
                    <span className="text-green-500 text-xs sm:text-sm font-medium">✓ Verified</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 sm:gap-6">
                ...
                <div className="lg:col-span-8">
                  <div className="bg-gray-50 rounded-lg p-4 sm:p-5">
                    <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Member Details</h2>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="bg-white p-3 rounded-lg border border-gray-200">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Full Name</p>
                        <p className="text-sm sm:text-base font-semibold text-gray-900 break-words">{memberData.Name}</p>
                      </div>
                      
                      <div className="bg-white p-3 rounded-lg border border-gray-200">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Member ID</p>
                        <p className="text-sm sm:text-base font-semibold text-gray-900 font-mono break-all">{memberData.Member_ID}</p>
                      </div>
                      
                      <div className="bg-white p-3 rounded-lg border border-gray-200">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Phone Number</p>
                        <p className="text-sm sm:text-base font-semibold text-gray-900 break-words">{memberData.Phone_Number}</p>
                      </div>
                      
                      <div className="bg-white p-3 rounded-lg border border-gray-200">
                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Email Address</p>
                        <p className="text-sm sm:text-base font-semibold text-gray-900 break-all">{memberData.Email}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {memberData.QRCode && (
                      <div className="bg-white rounded-lg p-4 border border-gray-200">
                        <h3 className="text-base font-semibold text-gray-900 mb-3">Event Pass</h3>
                        <div className="text-center">
                          ...
                          <p className="text-xs text-gray-600 mb-2">Present this QR code at the venue</p>
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-4 mx-4 sm:mx-6 mb-4">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <svg className="h-4 w-4 sm:h-5 sm:w-5 text-green-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="ml-3">
                  <p className="text-xs sm:text-sm text-green-700">
                    <span className="font-medium">Success!</span> Your registration has been completed. A confirmation email has been sent to your registered email address.
                  </p>
                </div>
              </div>
            </div>
